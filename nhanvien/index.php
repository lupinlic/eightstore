                ...
                <div class="slider  col-md-3 px-3 ">
                    <ul class="menu1 nav flex-column">
                        ...
                        <li class="nav-item ">
                          ...
                          <ul class="menu2">
                            <li class="menu2-item"><a href="order_offline.php">Đơn hàng tại quầy</a></li>
                            <li class="menu2-item"><a href="order_online.php">Đơn hàng trực tuyến</a></li>
                          </ul>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./views/nhacc.php"><i id="icon-sidebar" class="fa-solid fa-users"></i>Nhà cung cấp</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="./views/nhanvien.php"><i id="icon-sidebar" class="fa-solid fa-users"></i>Nhân viên</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="./views/taikhoan.php"><i id="icon-sidebar" class="fa-solid fa-user"></i>Tài khoản</a>
                        </li>
                        <li class="nav-item">
